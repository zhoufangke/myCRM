...
//				System.out.println("成功连接数据库");
			int a= sid;
			preparedStatement = conn.prepareStatement("select * from hetong where id='"+a+"'");
...
//				System.out.println("成功连接数据库");
			@SuppressWarnings("unused")
			int a=sid;
			preparedStatement = conn.prepareStatement("select * from hetong");
			ResultSet result1 = preparedStatement.executeQuery();
